        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>ICS Research Coordinator Accounts</h3>
                </div>
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">ICS Research Coordinator</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <section class="section">
        <div class="card shadow-sm">
            <div class="card-header mb-0 pb-0 text-center">
                <h5>ICS Research Coordinators</h5>
            </div>
                                    ...
                                    <td>
                                        <div class="">
                                            ...
                                            <div class="dropdown-menu shadow-lg">
                                                <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#view_profile_modal" data-user-picture="<?= $user['profile_path'] ?>" data-user-id="<?= $user['user_code'] ?>" data-user-name="<?= $user['full_name'] ?>" data-user-email="<?= $user['email'] ?>" data-user-department="<?= $department ?>" data-user-date="<?= $user['date_created'] ?>">
                                                    <i class="bi bi-eye me-3"></i> View</a>

                                                <a class="dropdown-item" href="/AdminController/AccountDelete/<?= $user['user_id'] ?>/2" onclick="return confirm('Are you sure you want to delete this user? This action cannot be undone.');">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        updateModal.addEventListener('show.bs.modal', function (event) {
            ...
            modaluserId.textContent = "ICS Research Coordinator #" + userId;
