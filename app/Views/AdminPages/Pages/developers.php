        ...
        <div class="row">
            <div class="col-sm-12 col-md-6 col-lg-3 mb-3">
                <div class="card h-100 d-flex flex-column shadow-sm">
                    <div class="card-header my-3 pb-3 text-center">
                        <img src="/landingPageAssets/images/developers/Binabise.jpg" class="rounded-circle mx-auto mb-4" style="width: 30%; object-fit: cover; aspect-ratio: 1/1;">
                    ...
                    <div class="card-footer">
                        ...
                        <small>
                            ...
                            Adviser: Mr. Ronald T. Lava, MSIT<br>
                            Email: binabise.joshua23@gmail.com
                        </small>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12 col-md-6 col-lg-3 mb-3">
                <div class="card h-100 d-flex flex-column shadow-sm">
                    <div class="card-header my-3 pb-3 text-center">
                        <img src="/landingPageAssets/images/developers/Andres.jpg" class="rounded-circle mx-auto mb-4" style="width: 30%; object-fit: cover; aspect-ratio: 1/1;">
                    ...
                    <div class="card-footer">
                        ...
                        <small>
                            School Year: 2024-2025<br>
                            Adviser: Mr. Ronald T. Lava, MSIT<br>
                            Email: andres.wanchobong09@gmail.com
                        </small>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12 col-md-6 col-lg-3 mb-3">
                <div class="card h-100 d-flex flex-column shadow-sm">
                    <div class="card-header my-3 pb-3 text-center">
                        <img src="/landingPageAssets/images/developers/Morales.jpg" class="rounded-circle mx-auto mb-4" style="width: 30%; object-fit: cover; aspect-ratio: 1/1;">
                    ...
                    <div class="card-footer">
                        ...
                        <small>
                            School Year: 2024-2025<br>
                            Adviser: Mr. Ronald T. Lava, MSIT<br>
                            Email: shawitottmorales2@gmail.com
                        </small>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12 col-md-6 col-lg-3 mb-3">
                <div class="card h-100 d-flex flex-column shadow-sm">
                    <div class="card-header my-3 pb-3 text-center">
                        <img src="/landingPageAssets/images/developers/Flores.jpg" class="rounded-circle mx-auto mb-4" style="width: 30%; object-fit: cover; aspect-ratio: 1/1;">
                    ...
                    <div class="card-footer">
                        ...
                        <small>
                            School Year: 2024-2025<br>
                            Adviser: Mr. Ronald T. Lava, MSIT<br>
                            Email: flores.thomsee08@gmail.com
                        </small>
                    </div>
                </div>
            </div>
