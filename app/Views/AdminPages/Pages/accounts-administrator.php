                                    ...
                                    <td>
                                        <div class="">
                                            ...
                                            <div class="dropdown-menu shadow-lg">
                                                <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#view_profile_modal" data-user-picture="<?= $user['profile_path'] ?>" data-user-id="<?= $user['user_code'] ?>" data-user-name="<?= $user['full_name'] ?>" data-user-email="<?= $user['email'] ?>" data-user-date="<?= $user['date_created'] ?>">
                                                    <i class="bi bi-eye me-3"></i> View</a>

                                                <a class="dropdown-item" href="/AdminController/AccountDelete/<?= $user['user_id'] ?>/1" onclick="return confirm('Are you sure you want to delete this program? This action cannot be undone.');">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        updateModal.addEventListener('show.bs.modal', function (event) {
            ...
            modaluserId.textContent = "Administrator #" + userId;
