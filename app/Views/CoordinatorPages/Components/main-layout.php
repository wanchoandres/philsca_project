...
<body>
    ...
    <div id="app">
        <!-- [ Side Navigation ] -->
        <?= $this->include('CoordinatorPages/Components/nav-side.php'); ?>

        <div id="main" class='layout-navbar navbar-fixed'>
            <!-- [ Top Navigation ] -->
            <?= $this->include('CoordinatorPages/Components/nav-top.php'); ?>

            <!-- [ Content ] -->
            <?= $this->renderSection('content'); ?>

            <!-- [ Footer ] -->
            <?= $this->include('CoordinatorPages/Components/footer.php'); ?>

            <!-- [ Toast ] -->
            <?= $this->include('CoordinatorPages/Components/toast.php'); ?>

            <script>
                <?= $this->include('CoordinatorPages/charts.js'); ?>
            </script>
        </div>
    </div>
