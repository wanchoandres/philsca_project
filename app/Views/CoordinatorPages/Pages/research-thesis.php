<?= $this->extend('/CoordinatorPages/Components/main-layout'); ?>
                                    ...
                                    <td class="col-1">
                                        <div class="">
                                            <button class="btn btn-outline-secondary btn-sm px-3" type="button" data-bs-toggle="modal" data-bs-target="#view_research_modal" 
                                                data-title="<?=$approved['thesis_title']?>" data-members="<?= str_replace('|', ', ', $approved['members']); ?>" data-file="<?=$approved['file_path']?>">View
                                            </button>
                                        </div>
                                    </td>
                                </tr>
                                    ...
                                    <td class="col-1">
                                        <div class="">
                                            ...
                                            <div class="dropdown-menu shadow-lg">
                                                <a class="dropdown-item" href="/CoordinatorController/ResearchThesisApprove/<?= $pending['thesis_id']; ?>" onclick="return confirm('Are you sure you want to approve this thesis?');">
        ...
        <div class="modal fade" id="reject_remark_modal" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-centered modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    ...
                    <form action="/CoordinatorController/ResearchThesisReject" method="post">
